...
describe("SoundPadComponent", () => {
  ...
  beforeEach(async () => {
    ...
    soundboardServiceSpy = TestBed.inject(
      SoundboardService,
    ) as jasmine.SpyObj<SoundboardService>;
    shortcutServiceSpy = TestBed.inject(
      ShortcutService,
    ) as jasmine.SpyObj<ShortcutService>;
  });
  ...
  describe("display", () => {
    ...
    it("should display duration", () => {
      ...
      const compiled = fixture.nativeElement as HTMLElement;
      const durationElement = compiled.querySelector(
  ...
  describe("events", () => {
    ...
    it("should emit trimmed name", () => {
      ...
      expect(component.customNameChange.emit).toHaveBeenCalledWith(
        "Trimmed Name",
      );
    });
